# program allows to create an account, login, logout, check balance,top up the card, transfer money, close an account
# Luhn algorithm is used to create and check valid card numbers
# SQLite is used to store an account information
import random
import sqlite3
