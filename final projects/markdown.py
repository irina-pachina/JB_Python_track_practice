# Program implements the formatters from Markdown language: plain, bold, italic, link, inline-code, header,
...
# example test input: ["header", "1", "Hello World!"]
# ["ordered-list", "2", "white", "green"]
